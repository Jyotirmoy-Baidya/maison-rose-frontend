...
const About = () => {
    ...
    return (
        <div className='xl:h-screen xl:w-screen bg-primary-bg cafe-bg-img'>
            <div className='grid grid-cols-4 xl:p-6 xl:gap-6 h-screen w-full'>
                {/* Navbar  */}
                <div className='absolute z-10  h-14 p-3 top-10 left-10 rounded-xl navbar bg-[#181818]'>
                    <div className='w-full h-full flex items-center'>
                        <div className='border-primary-border border-[1px] p-2 rounded-lg'><RxHamburgerMenu className='text-white' /></div>
